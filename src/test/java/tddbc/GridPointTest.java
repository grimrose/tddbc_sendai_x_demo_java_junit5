...
public class GridPointTest {
    ...
    class 文字列表記が取得できる {
        @Test
        void x座標が4でy座標が7である格子点の文字列表記を取得する() throws Exception {
            GridPoint sut = new GridPoint(4, 7);
            assertEquals("(4,7)", sut.notation());
        }

        @Test
        void x座標が3でy座標が8である格子点の文字列表記を取得する() throws Exception {
    ...
    class 同じ座標を持つか {
        @Test
        void 格子点_4_7_と格子点_4_7_は同じ座標を持つ() throws Exception {
            GridPoint sut = new GridPoint(4, 7);
            assertTrue(sut.hasSameCoordinatesWith(new GridPoint(4, 7)));
        }

        @Test
        void 格子点_4_7_と格子点_3_8_は同じ座標を持たない() throws Exception {
            GridPoint sut = new GridPoint(4, 7);
